...
# Жёсткие маркеры: бренды / явный CTA. Без «цена/коллекция/подписка» —
# они дают ложные срабатывания в рецептах и фитнес-текстах и блокировали публикацию.
РЕКЛАМНЫЕ_МАРКЕРЫ = [
    ...
    r'промокод', r'\bпромо\b', r'скидк', r'распродаж',
    r'закаж(и|ите)\s+(сейчас|онлайн|у\s+нас)',
    r'купи(те)?\s+(сейчас|онлайн|со\s+скидкой)',
    r'\bреклама\b', r'партн[её]рск(ий|ая|ое)\s+материал',
]
