...
def адаптировать_заголовок_для_русской_аудитории(заголовок, текст=''):
    """
    ✅ ИСПРАВЛЕНИЕ: Использует оригинальный заголовок из спарсенной статьи
    
    Удалена вся логика с жестко закодированными заголовками.
    Теперь просто возвращаем оригинальный заголовок из исходной статьи.
    """
    if not заголовок:
    ...
    # ✅ ВАЖНО: Возвращаем оригинальный заголовок как есть
    # Вся логика с жестко закодированными заголовками удалена
    return заголовок
