...
## Задача: Проверка сайта https://www.tabatatimer.ru/#timer

### ШАГ 1: Открыть сайт
1. Откройте браузер Comet
2. Перейдите на: https://www.tabatatimer.ru/#timer
...
2. Сохраните как: screenshot_www.tabatatimer.ru_#timer.png

### ШАГ 6: Отчет
Создайте отчет со следующей информацией:
- URL: https://www.tabatatimer.ru/#timer
