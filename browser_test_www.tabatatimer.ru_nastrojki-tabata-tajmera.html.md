...
## Задача: Проверка сайта https://www.tabatatimer.ru/nastrojki-tabata-tajmera.html

### ШАГ 1: Открыть сайт
1. Откройте браузер Comet
2. Перейдите на: https://www.tabatatimer.ru/nastrojki-tabata-tajmera.html
...
2. Сохраните как: screenshot_www.tabatatimer.ru_nastrojki-tabata-tajmera.html.png

### ШАГ 6: Отчет
Создайте отчет со следующей информацией:
- URL: https://www.tabatatimer.ru/nastrojki-tabata-tajmera.html
